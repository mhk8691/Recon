    ...
    <Box>
      ...
      >
        ...
        >
          ...
          >
            Scan IPs gives you greater control over your scanning <br />{" "}
            infrastructure by providing a static set of IP <br /> addresses.
            Upgrade your account to access this <br /> feature.
          </Typography>
          <Button
            variant="contained"
            color="inherit"
